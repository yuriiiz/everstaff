...
```bash
pip install everstaff-0.1.6-py3-none-any.whl

# With optional extras:
pip install "everstaff-0.1.6-py3-none-any.whl[lark]"    # Lark channel support
pip install "everstaff-0.1.6-py3-none-any.whl[otel]"    # OpenTelemetry tracing
pip install "everstaff-0.1.6-py3-none-any.whl[all]"     # Everything
```
