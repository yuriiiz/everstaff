import { Construction, BookOpen, Database } from 'lucide-react';
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#f9fafb' }}>
            <div style={{ padding: '0 24px', background: 'white', borderBottom: '1px solid #e5e7eb', display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '60px', flexShrink: 0 }}>
                <div>
                    <h1 style={{ fontSize: '15px', fontWeight: 700, color: '#111827', margin: 0 }}>Knowledge base</h1>
                </div>
            </div>
            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px' }}>
                <div style={{ textAlign: 'center', maxWidth: '500px' }}>
                    ...
                    <p style={{ fontSize: '16px', color: '#6b7280', lineHeight: '1.6', margin: 0 }}>
                        Knowledge Base features are under construction. You will soon be able to configure long-term memory, RAG knowledge bases, and personalized fact stores to provide more depth to your agents.
                    </p>
                    <div style={{ marginTop: '32px', display: 'flex', justifyContent: 'center', gap: '16px' }}>
                        <div style={{ padding: '12px 20px', background: 'white', border: '1px solid #e5e7eb', borderRadius: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                            ...
                            <span style={{ fontSize: '14px', fontWeight: 600, color: '#4b5563' }}>RAG Infrastructure</span>
                        </div>
                        <div style={{ padding: '12px 20px', background: 'white', border: '1px solid #e5e7eb', borderRadius: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                            <Database size={18} color="#9ca3af" />
                            <span style={{ fontSize: '14px', fontWeight: 600, color: '#4b5563' }}>Persistent Storage</span>
                        </div>
                    </div>
                </div>
            </div>
