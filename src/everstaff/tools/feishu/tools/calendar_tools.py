...
def make_feishu_calendar_tools(app_id: str, app_secret: str, domain: str = "feishu", auth_handler=None, user_open_id: str = "", token_store=None, base_scopes: list[str] | None = None, include_offline_access: bool = True):
