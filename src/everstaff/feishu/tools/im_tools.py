...
def make_feishu_im_tools(app_id: str, app_secret: str, domain: str = "feishu", auth_handler=None):
    ...
    async def feishu_send_message(
        receive_id: str, content: str, user_open_id: str,
    ...
    async def feishu_list_messages(
        container_id: str, user_open_id: str,
    ...
    async def feishu_list_chats(user_open_id: str, page_size: int = 20) -> str:
        """List user's chats.
    ...
    async def feishu_search_chats(query: str, user_open_id: str, page_size: int = 20) -> str:
